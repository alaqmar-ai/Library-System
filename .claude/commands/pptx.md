...
| Edit or create from template | See "Editing Presentations" section below |
| Create from scratch | See "PptxGenJS Tutorial" section below |
...
**Use for template analysis only** (choosing layouts). For visual QA, use `soffice` + `pdftoppm` to create full-resolution individual slide images--see above.
